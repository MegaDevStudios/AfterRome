...
public class SonOfMarsUpgradeShopConfig extends Configurator implements UpgradeShopConfig {
    ...
    public String getIronInsideName() {
        return Color.getTranslated((String) getValue("skill.iron-inside.name"));
    }

    public String getIronInsideLore() {
        return Color.getTranslated((String) getValue("skill.iron-inside.lore"));
    }

    public MenuItem getIronInsideItem() {
        return new MenuItem(
                Material.valueOf((String) getValue("skill.iron-inside.item")))
                .setName(getIronInsideName())
                .setLore(getIronInsideLore());
    }

    public String getIronOutsideName() {
        return Color.getTranslated((String) getValue("skill.iron-outside.name"));
    }

    public String getIronOutsideLore() {
        return Color.getTranslated((String) getValue("skill.iron-outside.lore"));
    }

    public MenuItem getIronOutsideItem() {
        return new MenuItem(
                Material.valueOf((String) getValue("skill.iron-outside.item")))
                .setName(getIronOutsideName())
                .setLore(getIronOutsideLore());
    }

    public String getLandingName() {
        return Color.getTranslated((String) getValue("skill.landing.name"));
    }

    public String getLandingLore() {
        return Color.getTranslated((String) getValue("skill.landing.lore"));
    }

    public MenuItem getLandingItem() {
        return new MenuItem(
                Material.valueOf((String) getValue("skill.landing.item")))
                .setName(getLandingName())
                .setLore(getLandingLore());
    }

    public String getMeleeCombatName() {
        return Color.getTranslated((String) getValue("skill.melee-combat.name"));
    }

    public String getMeleeCombatLore() {
        return Color.getTranslated((String) getValue("skill.melee-combat.lore"));
    }

    public MenuItem getMeleeCombatItem() {
        return new MenuItem(
                Material.valueOf((String) getValue("skill.melee-combat.item")))
                .setName(getMeleeCombatName())
                .setLore(getMeleeCombatLore());
    }

    public String getProteinDietName() {
        return Color.getTranslated((String) getValue("skill.protein-diet.name"));
    }

    public String getProteinDietLore() {
        return Color.getTranslated((String) getValue("skill.protein-diet.lore"));
    }

    public MenuItem getProteinDietItem() {
        return new MenuItem(
                Material.valueOf((String) getValue("skill.protein-diet.item")))
                .setName(getProteinDietName())
                .setLore(getProteinDietLore());
    }

    public String getShootingName() {
        return Color.getTranslated((String) getValue("skill.shooting.name"));
    }

    public String getShootingLore() {
        return Color.getTranslated((String) getValue("skill.shooting.lore"));
    }

    public MenuItem getShootingItem() {
        return new MenuItem(
                Material.valueOf((String) getValue("skill.shooting.item")))
